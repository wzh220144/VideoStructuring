...
python -u /home/tione/notebook/VideoStructuring/SceneSeg/pre/vit/extract_feat.py --data_root=/home/tione/notebook/dataset/train_5k_A/shot_transnet_v2 --use_gpu=1
