...
if __name__ == '__main__':
    ...
    parser.add_argument('--files_dir', default='/home/tione/notebook/dataset/train_5k_A/split', type=str)
    ...
    parser.add_argument('--extract_video', action="store_true", default=True)
    parser.add_argument('--extract_img', action="store_true", default=True)
    parser.add_argument('--extract_audio', action="store_true", default=True)
    parser.add_argument('--extract_asr', action="store_true", default=True)
    parser.add_argument('--extract_ocr', action="store_true", default=True)
    ...
    args.files_dir = '/home/tione/notebook/dataset/test_5k_2nd/shot_transnet_v2/output'
    args.feat_dir = '/home/tione/notebook/dataset/test_5k_2nd/shot_transnet_v2/split_feats'
    print(args)
    main(args, gen)

    args.files_dir = '/home/tione/notebook/dataset/train_5k_A/shot_transnet_v2/output'
    args.feat_dir = '/home/tione/notebook/dataset/train_5k_A/shot_transnet_v2/output_feats'
    print(args)
    main(args, gen)
